      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          <div className="hidden sm:mb-8 sm:flex sm:justify-center">
            <div className="relative rounded-full px-3 py-1 text-sm/6 text-gray-900 ring-1 ring-white/10 hover:ring-white/20">
              Empowering farmers with smart crop solutions.{' '}
          ...
          <div className="text-center">
            <h1 className="text-5xl font-semibold tracking-tight text-yellow-200 sm:text-7xl">
              Farming Made Smarter, Harvest Made Better.
            </h1>
            <p className="mt-8 text-lg font-medium text-gray-900 sm:text-xl/8">
              Access real-time crop insights, weather forecasts, soil health data, 
              and personalized guidance to maximize your yield and reduce costs.
            </p>
            <div className="mt-10 flex items-center justify-center gap-x-6">
              ...
              <Link href="#" className="text-sm/6 font-semibold text-yellow-500">
